...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Lantern v$VERSION</title>
      <link>https://github.com/domus-apps/lantern/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/lantern/releases/download/v$VERSION/Lantern.zip"
        $SIGNATURE_ATTRS
